            ...
            <div class="bg-white px-4 py-5 sm:px-6">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $diploma->date->starts_at ?? 'Sin Fecha' }}
                        </dd>
                    </div>
                    <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $diploma->date->ends_at ?? 'Sin Fecha' }}
                        </dd>
                    </div>
                    <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            ...
                            <x-jet-secondary-button wire:click="changeStatus"> {{ $status ?? 'No Dedinido' }}</x-jet-secondary-button>
                        </dd>
                    </div>
                    <div class="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            ...
                            <form action="{{route('diploma.zoom-link.update')}}" method="post">
                                @csrf

                                <input type="text" value="{{$zoomLink->id}}" hidden name="zoomLinkId">
                                <input type="text" value="{{$zoomLink->link}}" name="link">
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $diploma->revoe->key ?? 'Sin Descripcion' }}
                        </dd>
                    </div>
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $diploma->description ?? 'Sin Descripcion' }}
                        </dd>
                    </div>
        ...
        <div class="relative top-40 mx-auto shadow-lg rounded-md bg-white max-w-md">
            ...
            <div class="w-full max-w-md b">
                ...
                <form wire:submit.prevent="update" method="POST" enctype='multipart/form-data'
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="revoe_date">
                            Fecha de Registro Revoe
                        </label>
                        <input type="date" name="revoe_date" id="revoe_date" wire:model.defer="revoe_date"><br>
