        ...
        <div class="w-full border-collapse p-5 m-4 box-border rounded-lg bg-gray-100">
            ...
            <div class="w-full border-collapse box-border rounded-lg bg-gray-100">
                ...
                <div class="flex flex-col m-2 p-3 border-separate shadow-md bg-white">
                    ...
                    <input required list="users" class="p-2 my-2 rounded-lg" type="text" placeholder="Usuario"
                    ...
                    <input required
                        class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border  border-gray-600 placeholder-gray-400 p-2 my-1"
