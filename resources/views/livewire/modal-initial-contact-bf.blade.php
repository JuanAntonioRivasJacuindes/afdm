<div>
    <div>
        <section id="mainModal" x-data="{ modal: true }">
            <div class=" fixed inset-0 z-50 flex flex-col items-center justify-end overflow-y-auto bg-black bg-opacity-80 sm:justify-start"
                ...
                <div class="w-full px-2 transition-all transform sm:max-w-2xl overflow-y-scroll" role="dialog" aria-modal="true"
                    ...
                    <div class="bg-white rounded-sm shadow-md  ">
                        <div
                            ...
                            <h2>¡Hola Bienvenid@! 👋 por favor llena los siguintes campos para que un asesor se ponga en
                                contacto
                                contigo y le de seguimiento a tu interés</h2>
                            <button class="w-16 bg-green-500 text-white text-xl rounded-sm px-4 py-2"
                        ...
                        <div class="m-2  pb-3">
                            ...
                            <form action="{{ route('send.data') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <select id="diplomados_option" name="diplomado"
                                    ...
                                    @foreach ($diplomas_buenfin['diplomados'] as $diploma)
                                        <option value="{{ $diploma['assesor'] }} {{ $diploma['title'] }}">
