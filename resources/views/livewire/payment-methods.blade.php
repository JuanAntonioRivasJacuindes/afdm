<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class=" w-full flex flex-row text-center bg-gray-100 my-2 p-2 rounded-md border-2 hover:bg-gray-200 ">
        ...
        @foreach ($paymentMethods as $card)
            <div
                class=" w-full flex flex-row text-center bg-gray-100 my-2 p-2 rounded-md border-2 border-black hover:bg-gray-200 ">
                <div class="m-auto w-1/4 px-5 md:p-8 ">
