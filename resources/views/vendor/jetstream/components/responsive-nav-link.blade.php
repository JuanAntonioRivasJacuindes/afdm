...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-primary text-base font-medium primary bg-gray-100 focus:outline-none focus:primary focus:bg-primary focus:border-primary transition'
