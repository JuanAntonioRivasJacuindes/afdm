...
<?php $component->withAttributes([]); ?>
    ...
    <div class="w-full md:my-7  md:p-5">
        <div x-data="{ src: '<?php echo e(route('select.video')); ?>', title: 'Seleccione un video' }">

            <section class="w-full flex flex-col lg:flex-row bg-gray-100">

                <div class="w-full lg:w-8/12 flex flex-col">
                    <div class="bg-black aspect-16/9" style="padding:45.55% 0 0 0;position:relative;"><iframe
                    ...
                    <div class="w-full border-2 h-20 p-3 flex flex-row">
                        ...
                        <div class="w-1/3 m-auto">
                            <a href="<?php echo e($diploma->zoomLink->link ?? ''); ?>" class="flex flex-row" target="blank">
                    ...
                    <section>
                        <div
                            ...
                            <div class="list divided " x-data="{ selected: null }">
                                <?php $__currentLoopData = $diploma->subjects(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class=" bg-primary text-lg w-full my-1 text-white ">
                                        <div class="body">
                                            <p class="p-3 text-sm item cursor-pointer"
                                                x-on:click="selected !== <?php echo e($key); ?> ? selected = <?php echo e($key); ?> : selected = null">
                                    ...
                                    <div x-show="selected == <?php echo e($key); ?>" class=""
                                        x-transition.duration.200ms>
                                        <ol class="list-decimal ">
                                            <?php if($subject->videos()->count() == 0): ?>
                                            <span class="p-3 truncate   w-full">
                                                Aún no hay videos en esta sección
                                            </span>
                                        <?php endif; ?>
                                            <?php $__currentLoopData = $subject->videos(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                <button
                                                    x-on:click="src = '<?php echo e($video->iframe); ?>' , title='<?php echo e($video->name); ?>'"
                                                    class="p-1 border-2 w-full border-gray-600 truncate cursor-pointer">
                                                    <?php echo e($key + 1); ?>.- <?php echo e($video->name); ?>
                    ...
                    <div class="w-full">
                                        ...
                                        <div
                                            ...
                                            <div class="list divided " x-data="{ selected: null }">
                                                <?php $__currentLoopData = $diploma->subjects(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div x-show="selected == <?php echo e($key); ?>" class="w-full"
                                                        x-transition.duration.200ms>
                                                        <ol class="list-decimal ">
                                                            <?php if($subject->videos()->count() == 0): ?>
                                                                <span class="p-3 truncate  w-full">
                        ...
                        <div class="space-y-6" x-show="tab === 1">
                            ...
                            <p class="text-xl" x-show="tab === 1"
                                x-transition:enter="transition delay-200 duration-500 transform ease-in"
                                x-transition:enter-start="opacity-0">
                                <?php echo e($diploma->info->introduction ?? 'No Definido'); ?>
                        ...
                        <div class="space-y-6" x-show="tab === 2">
                            ...
                            <p class="text-xl" x-show="tab === 2"
                                x-transition:enter="transition delay-200 duration-500 transform ease-in"
                                x-transition:enter-start="opacity-0">
                                <?php echo e($diploma->info->objectives ?? 'No Definido'); ?>
                        ...
                        <div class="space-y-6" x-show="tab === 3">
                            ...
                            <ol class="list-decimal leading-5" x-show="tab === 3"
                                x-transition:enter="transition delay-200 duration-500 transform ease-in"
                                x-transition:enter-start="opacity-0">
                                <?php $__currentLoopData = $diploma->subjects(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($subject->name ?? 'noname'); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ol>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\dev.afodemy.com\resources\views/diploma/show.blade.php ENDPATH**/ ?>