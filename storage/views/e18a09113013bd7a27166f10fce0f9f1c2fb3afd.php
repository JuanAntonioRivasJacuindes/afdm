...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('admin')).'','active' => request()->routeIs('admin')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                    <?php endif; ?>
                   <?php if(auth()->check() && auth()->user()->hasRole('Coordinator')): ?>
                   <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('coordination')).'','active' => request()->routeIs('coordination')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('coordination')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('coordination'))]); ?>
                    <?php echo e(__('Coordinación')); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown-link','data' => ['href' => ''.e(route('admin')).'']]); ?>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="flex items-center px-4">
                    ...
                    <div>
                        ...
                        <div class="font-medium text-sm text-gray-100"><?php echo e(Auth::user()->email); ?></div>
                    </div>
                </div>
                ...
                <div class="mt-3 space-y-1">
                    <?php if(auth()->check() && auth()->user()->hasRole('Administrator')): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.responsive-nav-link','data' => ['href' => ''.e(route('admin')).'','active' => request()->routeIs('admin')]]); ?>
...
<?php endif; ?>
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('Coordinator')): ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.responsive-nav-link','data' => ['href' => ''.e(route('coordination')).'','active' => request()->routeIs('coordination')]]); ?>
<?php $component->withName('jet-responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('coordination')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('coordination'))]); ?>
...
<?php /**PATH C:\xampp\htdocs\dev.afodemy.com\resources\views/navigation-menu.blade.php ENDPATH**/ ?>